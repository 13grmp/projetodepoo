...
public class Cliente {
    private String cpf,nomeCompleto;
    private Sexo sexo; 
    private Date dataNascimento = new Date();
    private double renda;
    private Endereco endereco;

    public Cliente(String cpf,String nomeCompleto,Sexo sexo,Date date,double renda,Endereco endereco){
        this.cpf = cpf;
    ...
    public int obterIdade(){
        ...
        long idadeMillis = Math.abs(diferencaMillis);
        
        long idadeAnos = idadeMillis / (1000L * 60 * 60 * 24 * 365);
        
        return (int) idadeAnos;
    }
}